...
interface FileModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (data: { id?: string; name: string; companyId: string; isOfficial: boolean; folderId?: string }) => void;
...
export const FileModal: React.FC<FileModalProps> = ({ isOpen, onClose, onSave, pendingFiles, initialData, currentUser, companies, isOfficial = true }) => {
